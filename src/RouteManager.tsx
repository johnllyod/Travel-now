...
const RouteManager = () => {
  return (
    <Routes>
      <Route path="/" element={<Home countryInfo={travelPlaces} />} />
      <Route path="/About" element={<About />} />
      <Route path="/Country" element={<Country countryInfo={travelPlaces} />} />
      <Route path="/Search" element={<Search countryInfo={travelPlaces} />} />
    </Routes>
  );
};
